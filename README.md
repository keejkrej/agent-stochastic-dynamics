...
- Diagnostic counts (0731 toys; held-out airline \(I_{\mathrm{loop}}\) \(0.7\to 0.9\) at \(k=1\), including a regression; self-obs \(39+44\) \(0.5\to 0.0\) as illegal-apply evidence, not a lead; post-gate hang licenses \(I_{\mathrm{weight}}\), not a lead; not SOTA): `paper/ANALYSIS.md`
